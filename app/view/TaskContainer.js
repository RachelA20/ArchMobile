        ...
        toolBarButtons: [
            ...
            },
            {
                ...
                text: Ext.os.is.Phone ? LocaleManager.getLocalizedString('Complete', 'AssetAndEquipmentSurvey.view.TaskContainer') :
                    LocaleManager.getLocalizedString('Complete Inspection', 'AssetAndEquipmentSurvey.view.TaskContainer'),
                ...
                items: [
                    {
                        ...
                        items: [
                            {
                                text: LocaleManager.getLocalizedString('Equipment List', 'AssetAndEquipmentSurvey.view.TaskContainer'),
                                itemId: 'taskList'
