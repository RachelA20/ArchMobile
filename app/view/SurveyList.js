Ext.define('AssetAndEquipmentSurvey.view.SurveyList', {
    ...
    config: {
        title: Ext.os.is.Phone ? LocaleManager.getLocalizedString('Survey',
            ...
            LocaleManager.getLocalizedString('Asset & Equipment Inspections', 'AssetAndEquipmentSurvey.view.SurveyList'),
        ...
        items: [
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        options: [
                            {
                                "displayValue": LocaleManager.getLocalizedString('Inspection Date',
                                    'AssetAndEquipmentSurvey.view.SurveyList'),
                                "objectValue": "date"
                            },
                            {
                                "displayValue": LocaleManager.getLocalizedString('Inspection Code',
                                    'AssetAndEquipmentSurvey.view.SurveyList'),
                                "objectValue": "survey"
                            }
                        ]
            ...
            },
            {
                ...
                emptyText: '<div class="ab-empty-text">' +
                    LocaleManager.getLocalizedString('There are no downloaded inspections at this time.<br>Tap the Sync icon to retrieve assigned inspections.',
