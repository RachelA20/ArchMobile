...
Ext.define('AssetAndEquipmentSurvey.controller.Navigation', {
    ...
    onCommentsFieldFocus: function (field) {
        var fieldValue = field.getValue(),
            ...
            localizedDate = '',
            surveyInfo,
            surveyLabel = LocaleManager.getLocalizedString('Inspection Code', 'AssetAndEquipmentSurvey.controller.Navigation'),
            surveyDateLabel = LocaleManager.getLocalizedString('Inspection Date', 'AssetAndEquipmentSurvey.controller.Navigation');
