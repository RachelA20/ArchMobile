Ext.define('AssetAndEquipmentSurvey.controller.FloorPlan', {
    ...
    config: {
        ...
        surveyTaskMessage: LocaleManager.getLocalizedString('This support space is not included in the inspection.',
            'AssetAndEquipmentSurvey.controller.FloorPlan'),
        surveyTaskTitle: LocaleManager.getLocalizedString('Inspection Equipment', 'AssetAndEquipmentSurvey.controller.FloorPlan')
    },
