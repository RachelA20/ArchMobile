...
Ext.define('AssetAndEquipmentSurvey.controller.AssetAndEquipmentSurveySync', {
    ...
    config: {
        ...
        completeSurveyMessage: LocaleManager.getLocalizedString('By marking the inspection as Complete, you inform the supervisor that you are done with this inspection, that they can review your changes, apply them, and then close the inspection.<br><br>You cannot make further changes after you mark the inspection as Complete.<br><br>Proceed?',
    ...
    onCompleteSurvey: function () {
        var me = this,
            ...
            completeSurveyTitle = LocaleManager.getLocalizedString('Complete Inspection', 'AssetAndEquipmentSurvey.controller.AssetAndEquipmentSurveySync');
    ...
    executeMarkSurveyCompleted: function (surveyId) {
        var errorMsgTitle = LocaleManager.getLocalizedString('Error', 'AssetAndEquipmentSurvey.controller.AssetAndEquipmentSurveySync'),
            errorMsg = LocaleManager.getLocalizedString('Error Completing Inspection', 'AssetAndEquipmentSurvey.controller.AssetAndEquipmentSurveySync');
