//Edit Equipment Menu Model, where individual eq information is updated
...
Ext.define('AssetAndEquipmentSurvey.model.Task', {
	...
	//Rachel A. Sullivan 05.02.2018 Added description to task Model
            {
                name: 'description',
                type: 'string'
            },	
	//Rachel A. Sullivan 05.07.2018 Added condition, option1, option2, ai_status, and property_type to task Model
            {
                name: 'condition',
                type: 'string'
            },
