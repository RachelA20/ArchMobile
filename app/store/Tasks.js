//Edit Equipment Menu Store, where individual eq information is updated
...
Ext.define('AssetAndEquipmentSurvey.store.Tasks', {
    ...
    serverFieldNames: [
        ...
        'site_id',
        'survey_comments',
 //Rachel A. Sullivan 05.02.2018 Added description to task Store
		'description',
 //Rachel A. Sullivan 05.07.2018 Added condition, option1, option2, ai_status, date_manufactured, and property_type to task Store		
		'condition',
		'option1',
		'option2',
		'ai_status',
